...
def create_window_sensors(df_sensor_1, df_sensor_2, folder, length, overlap, normalize_data=False, filter_data=False, absolute_data=True):
    if filter_data:
    ...
    if absolute_data:
        df_sensor_1 = df_sensor_1.abs()
        df_sensor_2 = df_sensor_2.abs()
